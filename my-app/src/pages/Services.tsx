    ...
    <>
      ...
      <div className="text-section">
        ...
        >
          ...
          >
            At Ascendons, we specialize in transforming your ideas into innovative digital solutions. Whether you need a stunning website, a high-performance mobile app, or a custom software solution, we’ve got you covered. From startups to established enterprises, we work on everything where tech is needed.
          </p>
        </p>
        <Link
          ref={button2Ref}
      ...
      <section className="services-sect">
        ...
        >
          <p className="par">
            At Ascendons, we believe in delivering solutions that not only meet but exceed your expectations. Whether you're a startup looking to build your first app or an established business seeking to streamline operations, we’re here to help.
          </p>
        </div>
        <div
          ref={designRef}
        ...
        >
          <p className="par">
            We leverage cutting-edge tools and frameworks to create robust, scalable, and future-proof digital solutions tailored to your needs. From inventory management systems to AI-driven applications, we work on everything where tech is needed.
          </p>
        </div>
        <div
          ref={developmentRef}
        ...
        >
          <p className="par">
            Our approach is rooted in collaboration and innovation, ensuring that every project we undertake delivers measurable results. Let’s work together to create something extraordinary. Your success is our mission.
          </p>
        </div>
      </section>
      ...
      <div className="text-section">
        ...
        >
          ...
          <p
            ...
            className={`subpart3 ${subpartSlidUp[2] ? "slide-up" : ""}`}
          >
            Beyond our core offerings, we provide a range of specialized services to address your unique business challenges.
          </p>
        </p>
      </div>
      ...
      <section className="services-section">
        ...
        >
          ...
          <p className="para">
            We implement DevOps practices and CI/CD pipelines to accelerate software delivery and improve collaboration.
          </p>
        </div>
        <div
          ref={designRef}
        ...
        >
          ...
          <p className="para">
            We develop secure blockchain-based solutions for transactions, smart contracts, and decentralized applications.
          </p>
        </div>
        <div
          ref={developmentRef}
        ...
        >
          ...
          <p className="para">
            We design and develop cross-platform mobile apps to enhance customer engagement and streamline operations.
          </p>
        </div>
        <div
          ref={helpSupportRef}
        ...
        >
          ...
          <p className="para">
            We create intuitive and visually appealing interfaces to improve user experiences and drive satisfaction.
          </p>
        </div>
      </section>
    </>
